...
def main():
    ...
    # Test subparser
    test_parser = subparsers.add_parser("test", help="Test datasets (draw_label or count_images)")
    ...
    test_parser.add_argument(
        ...
        choices=["draw", "count"],
        required=True,
        help="Test mode: draw_label or count_images",
    )
    test_parser.add_argument(
        "--image-path",
        help="Path to image file (required for draw_label)",
    )
    test_parser.add_argument(
        "--label-path", 
        help="Path to label file (required for draw_label)",
    )
    test_parser.add_argument(
        "--image-dir",
        help="Path to images directory (required for count_images)",
    )
